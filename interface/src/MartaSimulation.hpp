#ifndef RPC_SIMULATION_GARFIELDSIMULATION_HPP
#define RPC_SIMULATION_GARFIELDSIMULATION_HPP
...
namespace RPC::GarfieldInterface {
    ...
    public:
        // Constantes para a geometria da RPC Marta do CBPF em cm.
        static constexpr double GARFIELD_VOLUME_X = 120.0;
        static constexpr double GARFIELD_VOLUME_Y = 5 * 2.0e-1;
        static constexpr double GARFIELD_VOLUME_Z = 152.0;

        explicit MartaSimulation(DetectorConfig config) : mDetectorConfig(std::move(config)) {}
...
#endif //RPC_SIMULATION_GARFIELDSIMULATION_HPP
