#ifndef DETECTORCONSTRUCTIONMARTA_HH
#define DETECTORCONSTRUCTIONMARTA_HH
...
namespace RPC::Geometry {
    ...
    class DetectorConstructionMarta : public G4VUserDetectorConstruction {
    public:
        explicit DetectorConstructionMarta(MainParameters* params);
        ~DetectorConstructionMarta() override;
...
#endif // DETECTORCONSTRUCTIONMARTA_HH
