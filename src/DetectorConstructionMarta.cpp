...
DetectorConstructionMarta::DetectorConstructionMarta(MainParameters *params) {
    this->params = params;
}

DetectorConstructionMarta::~DetectorConstructionMarta() {
}

G4VPhysicalVolume *DetectorConstructionMarta::Construct() {
...
void DetectorConstructionMarta::ConstructSDandField() {
